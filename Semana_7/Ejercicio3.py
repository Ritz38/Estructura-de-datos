...
class BinarySearchTree:
    ...
    def inOrder(self):
        self._inOrderRecursively(self.root, self.contador)
        return self.contador

    def _inOrderRecursively(self, root, contador):
        if root:
            self._inOrderRecursively(root.left, contador)
            if root.left == None and root.right == None: self.contador+=1
            self._inOrderRecursively(root.right, contador)
